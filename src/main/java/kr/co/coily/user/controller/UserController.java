...
//		String encPsw = PasswordEncoder
		...
		String content = ""
				...
				+ "<a href='http://localhost:9090/bit-finalT3/index.html'><button style='height:45px; width:172px; font-weight: 500; font-size: 25px; line-: 27px; word-spacing: -0.5px; display: inline-block; color: white; text-decoration: none; border-radius:5px; background:#4A90BE; border:solid 1px #4A90BE;'>coily 시작하기</button></a>"
				+ " </div>"
				...
				+ "아이쿠! 깜빡하고 인증페이지를 닫았나요?? <a href='http://localhost:9090/bit-finalT3/user/confForm.do?userEmail="+ email +"' style='color: inherit;' target='_blank'>인증하러가기</a>"
				+ " </h6>"
				+ " </td></tr></tbody>"
				+ "</table>"
