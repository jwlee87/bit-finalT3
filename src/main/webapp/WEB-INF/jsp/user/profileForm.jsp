...
<!-- 	<header> myPage </header> -->
	<div class="login">
		...
		<a id="characterImgPopup" href="${pageContext.request.contextPath}/user/characterImg.do"><div style="background-color: black;" class="photo"><img src="${userInfo.userImgPath}" style="width:100%; height: 100%;"></img></div></a>
