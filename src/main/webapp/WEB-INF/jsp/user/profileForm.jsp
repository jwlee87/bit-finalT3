...
<!-- 	<header> myPage </header> -->
	<div class="login">
		...
		<a id="characterImgPopup" href="${pageContext.request.contextPath}/user/characterImg.do" class="characterImgPopup" >
			<div class="photo">
				<img src="${userInfo.userImgPath}" style="width:100%; height: 100%; border-radius : 50%; background:white;" />
			</div>
		</a>
